...
- **render node**: Copies markdown from generate_documents to render directory, computes SHA256 manifest. Currently the refactored branch has `src/tools/render/` which is more advanced (Pandoc + Jinja2 + multi-engine).
