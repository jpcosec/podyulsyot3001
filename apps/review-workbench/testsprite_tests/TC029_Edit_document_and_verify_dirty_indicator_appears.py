...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /jobs/tu_berlin/999001/sculpt
        await page.goto("http://localhost:5173/jobs/tu_berlin/999001/sculpt")
        
        # -> Click into the CodeMirror markdown editor (index 297) and type '\n\nTest edit: add a new line.' to mark the document dirty.
