...
This directory contains the active frontend sandbox surfaces.

## Main areas

- `pages/NodeEditorSandboxPage.tsx` - node-to-node editor sandbox
- `pages/CvGraphEditorPage.tsx` - CV graph sandbox
- `pages/SandboxPage.tsx` and related sandbox entry views
