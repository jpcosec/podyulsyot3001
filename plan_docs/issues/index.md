...
1. `plan_docs/issues/gaps/trace-normalization-quality.md`
2. `plan_docs/issues/gaps/language-detection-hardening.md`
3. `plan_docs/issues/gaps/crawl4ai-llm-extraction-strategy.md`
4. `plan_docs/issues/gaps/representative-schema-samples.md`
5. `plan_docs/issues/gaps/browseros-domain-interface-boundary.md`
6. `plan_docs/issues/gaps/browseros-letter-upload-routing.md`

### Phase 2 — Built on the foundations

7. `plan_docs/issues/gaps/xing-listing-metadata-composition.md`
   - depends on `plan_docs/issues/gaps/discovery-entry-contract.md`
8. `plan_docs/issues/gaps/end-to-end-apply-coverage.md`
9. `plan_docs/issues/gaps/cross-motor-applymeta-consistency.md`
   - depends on `plan_docs/issues/gaps/end-to-end-apply-coverage.md`

### Phase 3 — Routing and apply enablement

10. `plan_docs/issues/unimplemented/application-routing-enrichment.md`
11. `plan_docs/issues/unimplemented/portal-routing-layer.md`
    - depends on `plan_docs/issues/unimplemented/application-routing-enrichment.md`
12. `plan_docs/issues/unimplemented/cross-portal-discovery.md`
    - depends on `plan_docs/issues/unimplemented/application-routing-enrichment.md`

### Phase 4 — Human loop, safety, and fallback execution

13. `plan_docs/issues/unimplemented/apply-hitl-channel.md`
14. `plan_docs/issues/unimplemented/credential-store.md`
15. `plan_docs/issues/unimplemented/anti-bot-danger-detection.md`
    - depends on `plan_docs/issues/unimplemented/apply-hitl-channel.md`
16. `plan_docs/issues/unimplemented/openbrowser-level2-integration.md`
    - depends on `plan_docs/issues/unimplemented/credential-store.md`
    - depends on `plan_docs/issues/unimplemented/apply-hitl-channel.md`

### Phase 5 — Higher-level capability

17. `plan_docs/issues/unimplemented/ats-form-analyzer.md`
18. `plan_docs/issues/unimplemented/conceptual-motors.md`
