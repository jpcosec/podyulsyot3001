...
- Added live-data extraction issues for stale real-page schemas and Ariadne ownership of canonical normalization. BrowserOS runtime reachability and the old schema-generation fallback are now resolved or superseded by the MCP-first contract.
...
- Depth 0: `plan_docs/issues/gaps/xing-live-extraction-remains-unstable.md`, `plan_docs/issues/gaps/canonical-job-normalization-is-not-owned-by-ariadne.md`
...
3. `plan_docs/issues/gaps/canonical-job-normalization-is-not-owned-by-ariadne.md`
