...
### Current Ariadne reference traces

- these are design/reference traces, not runtime code assets
- recommended destination:
  - keep design/reference material in Ariadne reference data, for example `data/ariadne/reference_data/applying_traces/`
- rule:
- if a trace is only documentation or exploratory evidence, keep it in Ariadne reference data
