...
|---|------|-------------|------------|
| 01 | [is-mission-complete-routing](01-is-mission-complete-routing.md) | Add `is_mission_complete` to `AriadneState` + wire terminal routing in `builder.py` | — |
| 02 | [delphi-llm-implementation](02-delphi-llm-implementation.md) | Full Delphi cold path: LLM call via BrowserOS MCP, Set-of-Mark, HITL escalation | 01 |
