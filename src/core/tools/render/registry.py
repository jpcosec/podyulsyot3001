...
from src.core.tools.render.documents.cv.adapter import CVDocumentAdapter
from src.core.tools.render.documents.letter.adapter import LetterDocumentAdapter
from src.core.tools.render.engines.base import EngineAdapter
from src.core.tools.render.engines.pandoc.docx_adapter import PandocDocxEngineAdapter
from src.core.tools.render.engines.pandoc.pdf_adapter import PandocPdfEngineAdapter
...
def load_style_manifest(document_type: str, style: str) -> StyleManifest:
    ...
    payload = DataManager().read_json_path(path)
