...
2. **Constraint Evaluation:** Explicitly look for work mode (remote/hybrid/onsite), timezone, legal status, visas, process, deadline, and contract constraints.
3. **Risk Analysis:** Identify contradictions or red flags that may affect candidate fit or process viability.
4. **Validation:** Ensure requirement IDs are unique and descriptive.
