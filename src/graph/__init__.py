...
def build_pipeline_graph(*, data_manager: DataManager | None = None) -> Any:
    ...
    workflow.add_edge("extract_bridge", "load_profile")
    workflow.add_edge("load_profile", "match_skill")
    workflow.add_conditional_edges(
        "match_skill",
        _route_after_match_skill,
        {"generate_documents": "generate_documents", "__end__": END},
    )
    workflow.add_conditional_edges(
        "generate_documents",
        _route_after_generate,
        {"render": "render", "__end__": END},
    )
    workflow.add_conditional_edges(
        "render",
        _route_after_render,
        {"package": "package", "__end__": END},
    )
