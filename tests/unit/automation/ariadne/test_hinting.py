...
async def test_hinting_tool_inject_hints():
    ...
    executor.execute.return_value = ExecutionResult(
        ...
        extracted_data={
            "hint_map": {
                "AA": {"selector": "[data-ariadne-hint='AA']", "text": "Click me", "rect": {"x": 10, "y": 10, "width": 50, "height": 20}},
                "AB": {"selector": "[data-ariadne-hint='AB']", "text": "Submit", "rect": {"x": 100, "y": 10, "width": 80, "height": 30}},
            }
        }
    )
    ...
    assert "ariadne-hint-container" in command.script
