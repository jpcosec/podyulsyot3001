...
Implementar un editor de grafos en React Flow para mapeo nodo a nodo, siguiendo la especificacion de interaccion definida en `docs/ui/node_editor_behavior_spec.md`, con una ruta de sandbox dedicada para validar UX antes de integrar datos reales.
