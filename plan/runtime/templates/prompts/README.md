...
See `plan/runtime/artifact_schemas.md` for full schema definitions.
...
5. Follow the two-file prompt anatomy (`system.md` + `user_template.md`) described in `plan/runtime/templates/prompts/prompt_anatomy_standard.md`.

See `plan/runtime/templates/llm/00_general_llm_call_template.md` for the canonical rendering template.
