...
- Not the owner of taxonomy definitions (owned by `plan/archive/execution_taxonomy_abstract.md`).
- Not the owner of artifact storage paths (owned by `plan/runtime/artifact_schemas.md`).
