...
> Status note (2026-03-20): this document is now primarily target-state/schema-design guidance. It should not be treated as an exact description of current runtime artifacts. For current runtime artifact behavior, use `docs/runtime/data_management.md` and `docs/runtime/node_io_matrix.md`.
...
- See `plan/runtime/sync_json_md.md` for the full parsing contract.
- See `plan/runtime/claim_admissibility_and_policy.md` for review directive format.
...
See `docs/policy/feedback_memory.md` for full schemas.
